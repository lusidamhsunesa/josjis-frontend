  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute h-[950px] left-[10px] top-[-407px] w-[672px] opacity-40">
        <img alt="" className="size-full object-cover pointer-events-none" src="/admin_login_decor.png" />
      </div>
      ...
      <div className="relative z-20 w-full max-w-[588px] h-[718px] rounded-[40px] border border-white/0 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md shadow-[0_0_42px_rgba(0,0,0,0.58),inset_0_30px_12px_-21px_rgba(0,0,0,0.32)] flex flex-col items-center pt-[100px] px-12 animate-slide-up">
        ...
        <form onSubmit={handleLogin} className="w-full flex flex-col items-center gap-[42px]">
          ...
          {error && <p className="text-yellow-400 font-bold text-center mt-[-20px] drop-shadow-sm">{error}</p>}
          ...
          >
            <span className="font-poppins font-semibold text-[24px] text-white tracking-wide">Login</span>
          </button>
        </form>
      </div>
