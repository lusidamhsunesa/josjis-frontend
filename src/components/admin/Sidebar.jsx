...
function MaterialSymbolsStarRounded({ className }) {
  return (
    <div className={className || "relative size-[40px] flex items-center justify-center"}>
      <img alt="" className="max-h-full max-w-full object-contain" src={imgVector} />
    </div>
  );
}
...
function MingcuteTimeFill({ className }) {
  return (
    <div className={className || "relative size-[40px] flex items-center justify-center"}>
      <img alt="" className="max-h-full max-w-full object-contain" src={imgGroup} />
    </div>
  );
}
...
function LetsIconsOrderFill({ className }) {
  return (
    <div className={className || "relative size-[40px] flex items-center justify-center"}>
      <img alt="" className="max-h-full max-w-full object-contain" src={imgVector1} />
    </div>
  );
}
...
function MaterialSymbolsEdit({ className }) {
  return (
    <div className={className || "relative size-[40px] flex items-center justify-center"}>
      <img alt="" className="max-h-full max-w-full object-contain" src={imgVector4} />
    </div>
  );
}
...
function MaterialSymbolsLightDashboardRounded({ className }) {
  return (
    <div className={className || "relative size-[40px] flex items-center justify-center"}>
      <img alt="" className="max-h-full max-w-full object-contain" src={imgVector5} />
    </div>
  );
}
...
function EntypoLogOut({ className }) {
  return (
    <div className={className || "relative size-[30px] flex items-center justify-center"}>
      <img alt="" className="max-h-full max-w-full object-contain" src={imgVector2} />
    </div>
  );
}
