  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col gap-2  bg-white/10">
        <h3 className="font-roboto font-black text-xl text-black truncate drop-shadow-sm">{product.name}</h3>
        <p className="font-paytone text-2xl text-black">
          Rp {typeof product.price === 'string' ? product.price : product.price.toLocaleString('id-ID')}
        </p>
